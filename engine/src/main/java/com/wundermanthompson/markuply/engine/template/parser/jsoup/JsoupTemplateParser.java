package com.wundermanthompson.markuply.engine.template.parser.jsoup;
...
public class JsoupTemplateParser implements TemplateParser {
  ...
  private ComponentFragment htmlToComponentFragment(Element templatingElement) {
    ...
    if (unwrapedSingleSection) {
      sections = Collections.singletonList(ComponentSectionFragment.instance(DEFAULT_SECTION_NAME, parseChildren(templatingElement)));
