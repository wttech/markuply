...
public class RequestCacheAspect {
  ...
  @Pointcut("@within(com.wundermanthompson.markuply.engine.request.cache.RequestCache)")
  public void withinAnnotatedClass() {
  }

  @Pointcut("@annotation(com.wundermanthompson.markuply.engine.request.cache.RequestCache)")
